...
func (s *Store) migrateMySQL() error {
	...
	queries := []string{
		...
		`CREATE TABLE IF NOT EXISTS oneminai_conversations (id VARCHAR(64) PRIMARY KEY, owner_hash VARCHAR(64) NOT NULL, key_hash VARCHAR(64) NOT NULL, upstream_id TEXT NOT NULL, model TEXT NOT NULL, created_at DATETIME(6) NOT NULL, updated_at DATETIME(6) NOT NULL, expires_at DATETIME(6) NOT NULL, INDEX idx_oneminai_conversations_expiry (expires_at)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`,
		`CREATE TABLE IF NOT EXISTS oneminai_assets (id VARCHAR(64) PRIMARY KEY, conversation_id VARCHAR(64) NOT NULL, owner_hash VARCHAR(64) NOT NULL, key_hash VARCHAR(64) NOT NULL, upstream_id TEXT NOT NULL, kind VARCHAR(16) NOT NULL, content_type TEXT NOT NULL, filename TEXT NOT NULL, size_bytes BIGINT NOT NULL, sha256 VARCHAR(64) NOT NULL, created_at DATETIME(6) NOT NULL, expires_at DATETIME(6) NOT NULL, UNIQUE KEY uq_oneminai_assets (conversation_id, owner_hash, key_hash, sha256), INDEX idx_oneminai_assets_expiry (expires_at)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`,
		`CREATE TABLE IF NOT EXISTS web_sessions (token_hash VARCHAR(64) PRIMARY KEY, expires_at DATETIME(6) NOT NULL, INDEX idx_web_sessions_expiry (expires_at)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`,
	}
